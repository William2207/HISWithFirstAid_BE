...
{
    /// <inheritdoc />
    public partial class TechniqueTypeTableChangetTechniqueTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // 3. THÊM DỮ LIỆU MẪU (QUAN TRỌNG!)
            migrationBuilder.InsertData(
                table: "TechniqueTypes",
                columns: new[] { "Name", "Description", "Icon", "Color" },
                values: new object[,]
                {
            { "Relaxation", "Kỹ thuật thư giãn", "🧘", "#4CAF50" },
            { "Cognitive", "Kỹ thuật nhận thức", "🧠", "#2196F3" },
            { "Breathing", "Kỹ thuật thở", "💨", "#00BCD4" },
            { "Physical", "Kỹ thuật vật lý", "💪", "#FF9800" }
                });
