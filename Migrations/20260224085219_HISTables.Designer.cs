...
namespace FirstAidAPI.Migrations
{
    ...
    [Migration("20260224085219_HISTables")]
    partial class HISTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirstAidAPI.Models.PatientProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FirstAidAPI.Models.Doctor", b =>
                {
                    b.HasBaseType("FirstAidAPI.Models.User");
            ...
            modelBuilder.Entity("FirstAidAPI.Models.Nurse", b =>
                {
                    ...
                    b.ToTable("Users", t =>
                        {
                            t.Property("IsAvailable")
                                .HasColumnName("Nurse_IsAvailable");
                        });
            ...
            modelBuilder.Entity("FirstAidAPI.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("FirstAidAPI.Models.PatientProfile", "PatientProfile")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("FirstAidAPI.Models.PatientProfile", b =>
                {
                    ...
                    b.HasOne("FirstAidAPI.Models.Patient", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
